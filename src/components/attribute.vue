...
export default {
  ...
  methods: {
    ...
    insertEmpty(file){
      ...
      var itemLeft = this.canvas.c.getActiveObject()._objects[1].left;
      var itemTop = this.canvas.c.getActiveObject()._objects[1].top;
      var itemHeight = this.canvas.c.getActiveObject()._objects[1].height;
      var itemWidth = this.canvas.c.getActiveObject()._objects[1].width;
      var itemScaleX = this.canvas.c.getActiveObject()._objects[1].scaleX;
      var itemScaleY = this.canvas.c.getActiveObject()._objects[1].scaleY;    
